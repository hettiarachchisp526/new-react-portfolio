    ...
    <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#202020] rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p className="mt-4 text-sm leading-relaxed text-gray-300">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                    ...
                    <ul className="mt-12 space-y-8">
                        <li className="flex items-center">
                            ...
                            <a href="mailto:ssubodha0526@gmail.com" className="ml-4 text-sm text-white">
                            ssubodha0526@gmail.com
                            </a>
                        </li>
                        <li className="flex items-center">
                            ...
                            <a href="tel:+94778425899" className="ml-4 text-sm text-white">
                                +94 778425899
                            </a>
                        </li>
                        <li className="flex items-center">
                ...
                <div className="p-6 bg-[#272727] rounded-lg">
                    ...
                    {/* <div className="space-y-4 max-lg:mt-4">
                        ...
                        <button type="button" className="px-4 py-2 mr-4 text-sm font-medium tracking-wider text-gray-800 bg-transparent border-2 border-gray-300 rounded-lg outline-none">Graphic design</button>
                        <button type="button" className="px-4 py-2 text-sm font-medium tracking-wider text-gray-800 bg-transparent border-2 border-gray-300 rounded-lg outline-none">Design system</button>
                    </div> */}

                    <form className="space-y-4 ">
                        <input type='text' placeholder='Name'
                            className="w-full rounded-lg py-3 px-4 text-white text-sm outline-[#686868]" />
                        <input type='email' placeholder='Email'
                            className="w-full rounded-lg py-3 px-4 text-white text-sm outline-[#686868]" />
                        <input type='text' placeholder='Subject'
                            className="w-full rounded-lg py-3 px-4 text-white text-sm outline-[#686868]" />
                        <textarea placeholder='Message' rows="6"
                            className="w-full rounded-lg px-4 text-white text-sm pt-3 outline-[#686868]"></textarea>
                        <button type='button'
                            className="text-white bg-orange-500 hover:bg-orange-700 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
